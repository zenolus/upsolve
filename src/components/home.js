...
class Home extends Component{
  ...
  handleHandleQuery = event => {
    ...
    const url = `${process.env.REACT_APP_SERVER}/suggest/${this.state.userHandle.trim()}/${this.state.counts.easy}/${this.state.counts.medium}/${this.state.counts.hard}` + (this.state.ratingLow ? `/${this.state.ratingLow}/${this.state.ratingHigh}` : ``)
